#include "QrAlignmentPatternLocations.h"
 ...
 void setpointmatrix(char **,int,int);

void  getAlignment(QR_Data *data,char **matrix)
{
  int aux=0;
  int aux2 =0;
  int aux3 =0;
  ...
  if (data->qrversion_number >= 2 && data->qrversion_number <= 6 )
  {

      if (data->qrversion_number == 2)
                aux = 18;
      else if (data->qrversion_number == 3)
                aux = 22;
      else if (data->qrversion_number == 4)
                aux = 26;
      else if (data->qrversion_number == 5)
                aux = 30;
      else if (data->qrversion_number == 6) //
                aux = 34;

      setpointmatrix(matrix,aux,aux);

  }
  else if (data->qrversion_number >= 7 && data->qrversion_number <= 13 )
  {
  ...
  else if (data->qrversion_number >= 14 && data->qrversion_number <= 20 )
  {

     if (data->qrversion_number == 14) //
     {
  ...
  else if (data->qrversion_number >= 21 && data->qrversion_number <= 27 )
  {

     if (data->qrversion_number == 21) // 6	28	50	72	94
     {
  ...
  else if (data->qrversion_number >= 28 && data->qrversion_number <= 34 )
  {


     if (data->qrversion_number == 28) // 6	26	50	74	98	122
     {
        aux =26; aux2 =50; aux3 =74; aux4 =98; aux5 = 122;
     }
     else if (data->qrversion_number == 29)// 6	30	54	78	102	126
     {
        aux =30; aux2 =54; aux3 =78; aux4 =102; aux5 = 126;
     }
     else if (data->qrversion_number == 30)// 6	26	52	78	104	130
     {
        aux =26; aux2 =52; aux3 =78; aux4 =104; aux5 = 130;
     }
     else if (data->qrversion_number == 31)// 6	30	56	82	108	134
     {
        aux =30; aux2 =56; aux3 =82; aux4 =108; aux5 = 134;
     }
     else if (data->qrversion_number == 32)// 6	34	60	86	112	138
     {
        aux =34; aux2 =60; aux3 =86; aux4 =112; aux5 = 138;
     }
     else if (data->qrversion_number == 33)// 6	30	58	86	114	142
     {
        aux =30; aux2 =58; aux3 =86; aux4 =114; aux5 = 142;
     }
     else if (data->qrversion_number == 34)// 6	34	62	90	118	146
     {
  ...
  else if (data->qrversion_number >= 35 && data->qrversion_number <= 40 )
  {


     if (data->qrversion_number == 35)
     {
...
void setpointmatrix(char **_matrix,int x,int y)
{
  int aux;
...
void getSeparation(int version ,int *separation)
{
...
int getNumberElements(int version)
{
